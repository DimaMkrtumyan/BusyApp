...
class SetNewPinViewController: UIViewController {
    ...
    @IBAction func confirmPressed(_ sender: UIButton) {
        forgotPinViewModel.changePin(phoneNumber, codeTextField.text!) { result in
            switch result {
            case .success():
                //Go Back To Login
                print("Changed")
...
extension SetNewPinViewController: UITextFieldDelegate {
...
extension SetNewPinViewController {
    
    ///Register for keyboard willHide willShow notifiication
    func registerKeyboardNotifications() {
        NotificationCenter.default.addObserver(self, selector: #selector(SetNewPinViewController.keyboardNotification(notification:)), name: UIResponder.keyboardWillChangeFrameNotification, object: nil)
    }
